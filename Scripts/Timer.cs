...
/// A timer
/// </summary>
public class Timer : EventInvoker
{
	#region Fields
	...
	void Update()
	{
		...
		if (running)
		{
			...
			float newCountdownValue = GetCurrentCountdownValue();
	...
	public void AddSeconds(float duration)
    {
	...
	float GetCurrentCountdownValue()
	{
